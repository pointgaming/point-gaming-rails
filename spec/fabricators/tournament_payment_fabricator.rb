Fabricator(:tournament_payment) do
...
Fabricator(:tournament_payment_bank_transfer, from: :tournament_payment) do
  source 'bank_account'
  bank_account_number '0123123123'
  bank_routing_number '1231231234'
end

Fabricator(:tournament_payment_credit_card, from: :tournament_payment) do
  source 'credit_card'
...
Fabricator(:tournament_payment_dwolla, from: :tournament_payment) do
  source 'dwolla'
  dwolla_account_id '1333224423'
end

Fabricator(:tournament_payment_paypal, from: :tournament_payment) do
  source 'paypal'
