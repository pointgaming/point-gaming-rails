class Admin::DisputeMessagesController < Admin::ApplicationController
  ...
  def create
    ...
    respond_with(@dispute_message, location: admin_dispute_url(@dispute, anchor: "message-#{@dispute_message._id}"))
  end
