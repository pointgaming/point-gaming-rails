class Stream
  ...
  def embedded_html=(value)
    value = Sanitize.clean(value, Sanitize::Config::EMBEDDED_CONTENT)
    write_attribute(:embedded_html, value)
  end
...
private
  ...
  def publish_updated
    BunnyWrapper.publish_fanout("c.#{self.mq_exchange}", {
