(function(window){
  ...
  window.PointGaming.views.dispute_messages = window.PointGaming.views.base.extend({
    ...
    bindEvents: function() {
      ...
      this.socket.on("Dispute.Message.new", function(data){ self.handleDisputeMessageCreated(data); });
    ...
    handleAjaxError: function(event, response, status_text) {
      var form = $('form#new_message'),
    ...
    handleDisputeMessageCreated: function(data) {
