Pointgaming::Application.configure do
  ...
  config.assets.precompile += %w( profile.js stream.js team.js user_streams.js disputes.js admin/disputes.js admin/groups.js billing.js subscriptions.js news.js )
